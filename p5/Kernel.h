header Kernel
  ...
  var
    ...
    hoarethreadManager: HoareThreadManager
  ...
  functions
    ...
    InitFirstProcess ()  --Function that will create a new thread and subsequently a process
  ...
  class HoareCondition
    ...
    methods
      Init ()
      Wait (mutex: ptr to HoareMutex, threadSem: ptr to Semaphore, nextCount: int)
      Signal (mutex: ptr to HoareMutex, threadSem: ptr to Semaphore, nextCount: int)
  endClass
