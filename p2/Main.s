...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x662c26e0 (decimal 1714169568)
	set	_packageName,r2
	set	0x662c26e0,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_313 = &_Global_lockP
	set	_Global_lockP,r1
	store	r1,[r14+-224]
!   Send message Init
	load	[r14+-224],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_lockC
	set	_Global_lockC,r1
	store	r1,[r14+-220]
!   Send message Init
	load	[r14+-220],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_lockB
	set	_Global_lockB,r1
	store	r1,[r14+-216]
!   Send message Init
	load	[r14+-216],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_316 = &_Global_emptyBuf
	set	_Global_emptyBuf,r1
	store	r1,[r14+-212]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_317 = &_Global_fullBuf
	set	_Global_fullBuf,r1
	store	r1,[r14+-208]
...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_4	! 16:	eatCheck
